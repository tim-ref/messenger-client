...
class CallReplacesTarget {
  ...
  factory CallReplacesTarget.fromJson(Map<String, dynamic> json) => CallReplacesTarget(
        id: json['id'].toString(),
...
class CallCapabilities {
  ...
  factory CallCapabilities.fromJson(Map<String, dynamic> json) => CallCapabilities(
...
class SDPStreamPurpose {
  ...
  factory SDPStreamPurpose.fromJson(Map<String, dynamic> json) => SDPStreamPurpose(
...
class SDPStreamMetadata {
  ...
  factory SDPStreamMetadata.fromJson(Map<String, dynamic> json) => SDPStreamMetadata(
        json.map(
...
class AssertedIdentity {
  ...
  factory AssertedIdentity.fromJson(Map<String, dynamic> json) => AssertedIdentity(

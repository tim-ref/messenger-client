  ...
  Future<bool> verifyTurnServer() async {
    ...
    try {
      await waitUntilAsync(() async {
        if (pc1!.connectionState == RTCPeerConnectionState.RTCPeerConnectionStateConnected &&
            pc2!.connectionState == RTCPeerConnectionState.RTCPeerConnectionStateConnected) {
          connected = true;
          return true;
        }
        return false;
      ...
      Logs().e('[VOIP] ConnectionTester Error while testing TURN server: ', e, s);
    }

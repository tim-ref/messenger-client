...
Future<bool> hasMediaDevice(
  ...
  return devices.where((device) => device.kind == mediaInputKind.name).isNotEmpty;
}
...
Future<void> updateMediaDevice(
  ...
  final sender = userRtpSenders.firstWhereOrNull((element) => element.track!.kind == kind.name);

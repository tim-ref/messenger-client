...
class MatrixDefaultLocalizations extends MatrixLocalizations {
  ...
  @override
  String acceptedTheInvitation(String targetName) => '$targetName accepted the invitation';
  ...
  @override
  String bannedUser(String senderName, String targetName) => '$senderName banned $targetName';

  @override
  String changedTheChatAvatar(String senderName) => '$senderName changed the chat avatar';
  ...
  @override
  String changedTheChatPermissions(String senderName) => '$senderName changed the chat permissions';
  ...
  @override
  String changedTheJoinRules(String senderName) => '$senderName changed the join rules';
  ...
  @override
  String changedTheProfileAvatar(String targetName) => '$targetName changed the profile avatar';

  @override
  String changedTheRoomAliases(String senderName) => '$senderName changed the room aliases';
  ...
  @override
  String get channelCorruptedDecryptError => 'The secure channel has been corrupted';

  @override
  String couldNotDecryptMessage(String errorText) => 'Could not decrypt message: $errorText';
  ...
  @override
  String invitedUser(String senderName, String targetName) => '$senderName has invited $targetName';
  ...
  @override
  String kicked(String senderName, String targetName) => '$senderName kicked $targetName';

  @override
  String kickedAndBanned(String senderName, String targetName) => '$senderName banned $targetName';
  ...
  @override
  String rejectedTheInvitation(String targetName) => '$targetName rejected the invitation';
  ...
  @override
  String sharedTheLocation(String senderName) => '$senderName shared the location';

  @override
  String unbannedUser(String senderName, String targetName) => '$senderName unbanned $targetName';
  ...
  @override
  String youInvitedBy(String senderName) => 'You have been invited by $senderName';
  ...
  @override
  String youKickedAndBanned(String targetName) => 'You kicked and banned $targetName';
  ...
  @override
  String wasDirectChatDisplayName(String oldDisplayName) => 'Empty chat (was $oldDisplayName)';
  ...
  @override
  String canceledKeyVerification(String senderName) => '$senderName canceled key verification';

  @override
  String completedKeyVerification(String senderName) => '$senderName completed key verification';
  ...
  @override
  String requestedKeyVerification(String senderName) => '$senderName requested key verification';

  @override
  String startedKeyVerification(String senderName) => '$senderName started key verification';
}

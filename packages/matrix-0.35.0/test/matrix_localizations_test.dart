...
void main() {
  ...
  group('Matrix Localizations', () {
    test('Matrix Localizations', () {
      expect(
        HistoryVisibility.invited.getLocalizedString(MatrixDefaultLocalizations()),
        'From the invitation',
      );
      expect(
        HistoryVisibility.joined.getLocalizedString(MatrixDefaultLocalizations()),
        'From joining',
      );
      expect(
        HistoryVisibility.shared.getLocalizedString(MatrixDefaultLocalizations()),
        'Visible for all participants',
      );
      expect(
        HistoryVisibility.worldReadable.getLocalizedString(MatrixDefaultLocalizations()),

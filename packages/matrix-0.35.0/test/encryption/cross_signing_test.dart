...
void main() {
  group('Cross Signing', tags: 'olm', () {
    ...
    test('selfSign', () async {
      ...
      expect(
        FakeMatrixApi.calledEndpoints.containsKey('/client/v3/keys/signatures/upload'),
        true,
      );
    ...
    test('sign', () async {
      ...
      final body = json.decode(
        FakeMatrixApi.calledEndpoints['/client/v3/keys/signatures/upload']!.first,
      );
      expect(
      ...
      expect(
        body['@othertest:fakeServer.notExisting'].containsKey(
          client.userDeviceKeys['@othertest:fakeServer.notExisting']?.masterKey?.publicKey,
        ),
        true,
      );
    });

...
void main() {
  group('Online Key Backup', tags: 'olm', () {
    ...
    test('load key', () async {
      ...
      expect(
        client.encryption!.keyManager.getInboundGroupSession(roomId, sessionId)?.sessionId,
        sessionId,
      );
    });
    ...
    test('upload key', () async {
      ...
      final payload = FakeMatrixApi.calledEndpoints['/client/v3/room_keys/keys?version=5']!.first;
      ...
      client.encryption!.keyManager.clearInboundGroupSessions();
      var ret = client.encryption!.keyManager.getInboundGroupSession(roomId, sessionId);
      expect(ret, null);
      await client.encryption!.keyManager.loadFromResponse(onlineKeys);
      ret = client.encryption!.keyManager.getInboundGroupSession(roomId, sessionId);

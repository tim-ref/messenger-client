...
void main() {
  group('SSSS', tags: 'olm', () {
    ...
    test('store', () async {
      ...
      await handle.ssss.store('best animal', 'foxies', handle.keyId, handle.privateKey!);
    ...
    test('cache', () async {
      ...
      expect(
        (await client.encryption!.ssss.getCached(EventTypes.CrossSigningSelfSigning)) != null,
        false,
      );
      expect(
        (await client.encryption!.ssss.getCached(EventTypes.CrossSigningUserSigning)) != null,
        false,
      );
      ...
      expect(
        (await client.encryption!.ssss.getCached(EventTypes.MegolmBackup)) != null,
        true,
      );
    });

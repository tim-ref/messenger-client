...
void main() {
  ...
  group('Call tests', () {
    ...
    test('Call connection and hanging up', () async {
      ...
      while (voip.currentCID != VoipId(roomId: room.id, callId: 'originTsValidCall')) {
      ...
      call.pc!.onIceGatheringState!.call(RTCIceGatheringState.RTCIceGatheringStateComplete);
      ...
      await call.sendCallCandidates(
        ...
        [
          ...
          {
            'candidate': 'candidate:3 1 TCP 2105524479 uwu 9 typ host tcptype active',
            'sdpMid': '0',
            'sdpMLineIndex': 0,
          }
        ],
      ...
      call.pc!.onIceConnectionState!.call(RTCIceConnectionState.RTCIceConnectionStateChecking);
      call.pc!.onIceConnectionState!.call(RTCIceConnectionState.RTCIceConnectionStateConnected);
    ...
    test('Call answered elsewhere', () async {
      ...
      while (voip.currentCID != VoipId(roomId: room.id, callId: 'answer_elseWhere')) {
        // call invite looks valid, call should be created now :D
        await Future.delayed(Duration(milliseconds: 50));
        Logs().d('Waiting for currentCID to update');
      }
                  ...
                  events: [
                    MatrixEvent(
                      ...
                      content: {
                        ...
                        'version': '1',
                        'lifetime': 10000,
                        'selected_party_id': 'not_us', // selected some other device for answer
                      },
                      senderId: '@alice:testing.com',
                      eventId: 'callerSelectAnswerEvent',
                      originServerTs: DateTime.now(),
    ...
    test('Reject incoming call', () async {
      ...
      while (voip.currentCID != VoipId(roomId: room.id, callId: 'reject_call')) {
        // call invite looks valid, call should be created now :D
        await Future.delayed(Duration(milliseconds: 50));
        Logs().d('Waiting for currentCID to update');
      }
          ...
          content: {
            'memberships': [
              CallMembership(
                ...
                backend: MeshBackend(),
                deviceId: '1111',
                expiresTs: DateTime.now().add(Duration(hours: 12)).millisecondsSinceEpoch,
                roomId: room.id,
          ...
          content: {
            'memberships': [
              CallMembership(
                ...
                backend: MeshBackend(),
                deviceId: '1111',
                expiresTs: DateTime.now().subtract(Duration(hours: 1)).millisecondsSinceEpoch,
                roomId: room.id,
                membershipId: voip.currentSessionId,
              ).toJson(),
            ],

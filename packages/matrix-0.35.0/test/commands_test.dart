...
void main() {
  group('Commands', tags: 'olm', () {
    ...
    test('join', () async {
      ...
      expect(
        FakeMatrixApi.calledEndpoints['/client/v3/join/!newroom%3Aexample.com']?.first != null,
        true,
      );
    });
    ...
    test('leave', () async {
      ...
      expect(
        FakeMatrixApi
                .calledEndpoints['/client/v3/rooms/!1234%3AfakeServer.notExisting/leave']?.first !=
            null,
        true,
      );
    });
    ...
    test('kick', () async {
      ...
      expect(
          json.decode(
            FakeMatrixApi
                .calledEndpoints['/client/v3/rooms/!1234%3AfakeServer.notExisting/kick']?.first,
          ),
          {
    ...
    test('ban', () async {
      ...
      expect(
          json.decode(
            FakeMatrixApi
                .calledEndpoints['/client/v3/rooms/!1234%3AfakeServer.notExisting/ban']?.first,
          ),
          {
            'user_id': '@baduser:example.org',
          });
    ...
    test('unban', () async {
      ...
      expect(
          json.decode(
            FakeMatrixApi
                .calledEndpoints['/client/v3/rooms/!1234%3AfakeServer.notExisting/unban']?.first,
          ),
          {
            'user_id': '@baduser:example.org',
          });
    ...
    test('invite', () async {
      ...
      expect(
          json.decode(
            FakeMatrixApi
                .calledEndpoints['/client/v3/rooms/!1234%3AfakeServer.notExisting/invite']?.first,
          ),
          {
            'user_id': '@baduser:example.org',
          });
    ...
    test('markasgroup', () async {
      ...
      expect(
        json
            ...
            .entries
            .any(
              (e) => (e.value as List<dynamic>).contains('!1234:fakeServer.notExisting'),
            ),
        false,
      );
    });

...
class MockRTCPeerConnection implements RTCPeerConnection {
  ...
  RTCIceGatheringState? get iceGatheringState => RTCIceGatheringState.RTCIceGatheringStateComplete;
  ...
  @override
  // value doesn't matter we do onIceConnectionState.call manually
  RTCIceConnectionState? get iceConnectionState => RTCIceConnectionState.RTCIceConnectionStateNew;
  ...
  @override
  Future<List<RTCRtpTransceiver>> get transceivers => throw UnimplementedError();
}
...
class MockRTCRtpReceiver implements RTCRtpReceiver {
  @override
  Function(RTCRtpReceiver rtpReceiver, RTCRtpMediaType mediaType)? onFirstPacketReceived;

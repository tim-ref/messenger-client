...
void main() async {
  group('Timeline', () {
    ...
    test('archive room not loaded', () async {
      final archiveRoom = client.getArchiveRoomFromCache('!5345234234:example.com');
    ...
    test(
      ...
      () async {
        ...
        final inboundSession = client.encryption!.keyManager.getInboundGroupSession(
          roomid,
        ...
        final encryptedEvent = await client.encryption!.encryptGroupMessagePayload(
          roomid,

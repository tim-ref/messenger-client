...
class ApiClient {
  ApiClient({
    this.basePath = 'https://tobereplaced.de/tim-information',
    this.authentication,
  });
  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'InfoObject':
          return InfoObject.fromJson(value);
        case 'V1ServerFindByIkGet200Response':
          return V1ServerFindByIkGet200Response.fromJson(value);
        case 'V1ServerIsInsuranceGet200Response':
          return V1ServerIsInsuranceGet200Response.fromJson(value);
        default:
          dynamic match;
          if (value is List &&

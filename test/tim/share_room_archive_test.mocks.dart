...
import 'package:fluffychat/tim/shared/matrix/tim_matrix_crypto.dart' as _i7;
...
class _FakeEvent_3 extends _i1.SmartFake implements _i3.Event {
  _FakeEvent_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockTimMatrixClient extends _i1.Mock implements _i4.TimMatrixClient {
  ...
  @override
  _i3.Room? getRoomById(String? id) => (super.noSuchMethod(Invocation.method(
        #getRoomById,
        [id],
      )) as _i3.Room?);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTimMatrixCrypto extends _i1.Mock implements _i7.TimMatrixCrypto {
  MockTimMatrixCrypto() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i6.Future<_i3.Event> decryptRoomEvent(
    ...
    _i3.Event? event,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i6.Future<_i3.Event>.value(_FakeEvent_3(
          this,
          Invocation.method(
            #decryptRoomEvent,
            [

/*
 * Modified by akquinet GmbH on 2025-12-05
          ...
          : <Widget>[
              KeyBoardShortcuts(
                ...
                child: AnimatedContainer(
                  ...
                  child: Semantics(
                    label: "showAttachmentOptionsButton",
                    container: true,
              ...
              if (!PlatformInfos.isMobile || controller.inputText.isNotEmpty || controller.isEditEvent)
                Container(
                  height: 56,
                  alignment: Alignment.center,
                  child: Semantics(
...
class _ChatAccountPicker extends StatelessWidget {
  ...
  void _popupMenuButtonSelected(String mxid, BuildContext context) {
    ...
    controller.setMatrixClient(client);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: FutureBuilder<Profile>(
        future: controller.matrixClient.fetchOwnProfile(),

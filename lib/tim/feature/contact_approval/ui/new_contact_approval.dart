...
import 'package:fluffychat/tim/feature/contact_approval/ui/new_contact_approval_view.dart';

class NewContactApproval extends StatefulWidget {
  const NewContactApproval({Key? key}) : super(key: key);

  @override
  NewContactApprovalController createState() => NewContactApprovalController();
}

class NewContactApprovalController extends State<NewContactApproval> {
  ...
  @override
  Widget build(BuildContext context) => NewContactApprovalView(this);
}
